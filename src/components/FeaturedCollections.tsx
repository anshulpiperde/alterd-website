...
const FeaturedCollections: React.FC = () => {
  return (
    <section className="py-16 bg-zara-off-white">
      <div className="max-w-[1280px] mx-auto px-6">
        <h2 className="text-3xl font-bold text-center mb-12 text-zara-near-black">Featured Collections</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {featuredCollections.map((collection) => (
            ...
            >
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-t from-zara-near-black/60 via-transparent to-transparent" />
